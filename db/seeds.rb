tatooine = Planet.create(name: "Tatooine",
language: "Basic, Bocce, Huttese, Jawaese, Tusken", sector: "Arkanis",
region: "Outer Rim Territories", description: "Tatooine is a sparsely inhabited desert planet. It has two suns, which provide striking sunsets.")
Planet.create(name: "Alderaan", language: "Basic", sector: "Alderaan",
region: "Core Worlds",
description: "Alderaan was destroyed in 0 BBY by the first Death Star.")
Planet.create(name: "Yavin IV",
language: "Yuuzhan Vong, Massassi, Critokian, Basic", sector: "Gordian Reach",
region: "Outer Rim Territories", description: "Yavin IV is one of the moons orbiting Yavin, a gas giant. During the Galactic Civil War, the Rebellion had a base on Yavin IV, which launched an attack that successfully destroyed the first Death Star.")
Planet.create(name: "Hoth", language: "Basic", sector: "Anoat",
region: "Outer Rim Territories",
description: "Hoth is made up entirely of snow and ice, and is surrounded by an asteroid belt. The temperature drops to well-below freezing at nightfall.")
Planet.create(name: "Dagobah", language: "Basic", sector: "Sluis",
region: "Outer Rim Territories",
description: "Dagobah is a harsh, humid, swampy planet, mostly covered in shallow marshland. It is also home to stifling forests, caves, and a diverse selection of flora and fauna.")
Planet.create(name: "Bespin", language: "Basic, Ugnaught", sector: "Anoat",
region: "Outer Rim Territories",
description: "Bespin is a gas giant, and is a major source of tibanna gas. It is home to many gas mining operations, which are the hubs of civilization on Bespin.")
Planet.create(name: "Endor", language: "Ewokese, Yuzzum", sector: "Moddell",
region: "Outer Rim Territories", description: "placeholder")
Planet.create(name: "Naboo", language: "Basic", sector: "Chommell",
region: "Mid Rim", description: "placeholder")
Planet.create(name: "Coruscant", language: "Basic, and thousands more",
sector: "Corusca", region: "Core Worlds", description: "placeholder")
kamino = Planet.create(name: "Kamino", language: "Basic, Kaminoan",
sector: "Abrion", region: "Beyond the Outer Rim Territories", description: "placeholder")
Planet.create(name: "Geonosis", language: "Geonosian hive-mind",
sector: "Arkanis", region: "Outer Rim Territories", description: "placeholder")
Planet.create(name: "Utapau", language: "Basic", sector: "Tarabba",
region: "Outer Rim Territories", description: "Utapau is a remote planet in the Outer Rim Territories which is full of massive sinkholes.")
Planet.create(name: "Mustafar", language: "Mustafarian", sector: "Atravis",
region: "Outer Rim Territories", description: "Mustafar is an incredibly hot world, which holds many valuable minerals mined by the Techno Union. Due to the planet's surface being made up entirely of lava, all buildings are held up by gravity supports.")
Planet.create(name: "Kashyyyk", language: "Shyriiwook", sector: "Mytaranor",
region: "Mid Rim", description: "Kashyyyk is a jungle planet orbiting a single star. It is covered in wroshyr trees and teeming with flora and fauna.")
