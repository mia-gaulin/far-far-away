...
# Planet.create(name: "Alderaan", language: "Basic", sector: "Alderaan", region: "Core Worlds")
# Planet.create(name: "Yavin IV", language: "Yuuzhan Vong, Massassi, Critokian, Basic", sector: "Gordian Reach", region: "Outer Rim Territories")
# Planet.create(name: "Hoth", language: "Basic", sector: "Anoat", region: "Outer Rim Territories")
# Planet.create(name: "Dagobah", language: "Basic", sector: "Sluis", region: "Outer Rim Territories")
# Planet.create(name: "Bespin", language: "Basic, Ugnaught", sector: "Anoat", region: "Outer Rim Territories")
# Planet.create(name: "Endor", language: "Ewokese, Yuzzum", sector: "Moddell", region: "Outer Rim Territories")
# Planet.create(name: "Naboo", language: "Basic", sector: "Chommell", region: "Mid Rim")
# Planet.create(name: "Coruscant", language: "Basic, and thousands more", sector: "Corusca", region: "Core Worlds")
# Planet.create(name: "Kamino", language: "Basic, Kaminoan", sector: "Abrion", region: "Beyond the Outer Rim Territories")
# Planet.create(name: "Geonosis", language: "Geonosian hive-mind", sector: "Arkanis", region: "Outer Rim Territories")
...
Planet.create(name: "Saleucami", language: "Basic, Wroonian", sector: "Suolriep", region: "Outer Rim Territories", description: "Saleucami is a dim, arid world with scattered oases of plant growth. Its name means 'Oasis' in Wroonian, and it was so named because it was the only habitable planet within a system filled with dead worlds and meteors. These uninhabitable meteors frequently crossed paths with the planet's orbit and bombarded its surface creating calderas, and stirring up subterranean waters and minerals. These waters and minerals turned the calderas into life-filled pockets on the planet's surface.

These craters of fertile soil were heated by geothermal vents and became the location of the earliest colonies on Saleucami. The planet became a trading post as a result. Saleucami had no indigenous sentient species, but its pleasant climate brought colonists to it")
